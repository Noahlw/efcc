...
export const COPY = {
  ...
  attendance: {
    ...
    selfHint: "掃描場地顯示的二維碼。",
    selfScanStart: "開始掃描",
    manualFallbackTitle: "輸入聚會代碼",
    manualFallbackDescription: "相機不可用時，輸入現場顯示的六位數代碼。",
    cameraPermissionTitle: "只在你按下後使用相機",
    cameraPermissionNote: "相機權限只會在開始掃描時請求。",
    guestTitle: "訪客簽到",
    guestHint: "輸入聚會代碼及聯絡資料，完成今次出席記錄。",
    guestCodeLabel: "聚會代碼",
    guestCodePlaceholder: "例如 482913",
    guestName: "姓名",
    guestPhone: "電話號碼",
    guestFields: "訪客資料",
    guestPhoneHint: "只用於今次聚會跟進。",
    guestSubmit: "確認簽到",
    guestSubmitting: "送出中…",
    success: "簽到成功。",
    duplicate: "你已完成此聚會簽到。",
    selfResultSuccessTitle: "簽到完成",
    selfResultSuccessCopy: "簽到成功。",
    selfResultDuplicateTitle: "已完成簽到",
    selfResultDuplicateCopy: "你已在此聚會簽到，無需重複。",
    resultReturnHome: "返回首頁",
    resultScanAgain: "再次簽到",
    guestResultTitle: "訪客簽到完成",
    guestResultCopy: "歡迎參加今晚聚會。你的資料已安全提交。",
    guestDuplicate: "此電話已簽到。如需協助，請聯絡聚會負責人。",
    guestResultDuplicateTitle: "訪客簽到已完成",
    guestResultComplete: "完成",
    ...
    sheetProgramQr: "課程 QR 碼",
    sheetProgramQrUnavailable: "課程 QR 碼未提供",
    sheetEventTime: "聚會日期及時間",
    sheetRoster: "簽到名單",
    sheetNoAttendees: "目前沒有簽到紀錄。",
  ...
  home: {
    kicker: "首頁內容",
    loading: "正在載入首頁內容…",
    loadError: "首頁內容暫時無法載入。",
    retry: "重試載入首頁",
    templateALabel: "近期聚會優先",
    templateBLabel: "教會消息優先",
    fallbackNotice: "目前未有已發佈首頁內容，以下顯示最早的可用聚會。",
    eventFallbackTitle: "即將舉行的聚會",
    eventTime: "時間",
    eventLocation: "地點",
    emptyTitle: "目前沒有即將舉行的聚會",
    emptyHint: "首頁內容會在有可用聚會或已發佈消息時顯示。",
    explorePrograms: "探索課程與活動",
    bodyEmpty: "這則消息目前沒有可顯示的正文。",
    externalLink: "外部連結",
    imageAlt: "首頁消息圖片",
    noticeSectionTitle: "教會消息",
    noticeBack: "首頁",
    viewDetails: "查看詳情",
    noticeDetailLoading: "正在載入教會消息…",
    noticeDetailRetry: "重試載入教會消息",
    noticeDetailLoadError: "教會消息暫時無法載入。",
    editorTitle: "首頁內容",
    editorLead: "編輯首頁聚會或教會消息，可切換手機或桌面寬度檢視預覽。",
    editorLoading: "正在載入首頁草稿…",
    draftSaved: "草稿已儲存。",
    published: "首頁內容已發佈。",
    conflictTitle: "首頁內容已被其他管理員更新。",
    conflictHint:
      "你的未儲存內容仍然保留；請先載入最新版本，再決定是否重新套用。",
    reloadLatest: "載入最新版本",
    templateChoice: "首頁模板",
    featuredEventId: "主打聚會 ID",
    featuredEventPlaceholder: "輸入聚會 ID（可留空以使用自動回退）",
    featuredEventHint: "留空時，首頁會顯示最早的可用 Active Listed 聚會。",
    titleLabel: "標題",
    summaryLabel: "摘要",
    bodyLabel: "正文",
    bodyHint: "正文會由伺服器消毒；不要貼上原始 HTML、script 或 embed。",
    ctaLabel: "按鈕文字",
    ctaUrl: "按鈕連結",
    imageUrl: "外部圖片網址",
    imageAltLabel: "圖片替代文字",
    imageHint: "只接受 HTTPS 圖片網址；圖片必須填寫替代文字。",
    publishMode: "發佈方式",
    publishImmediate: "立即發佈",
    publishScheduled: "排程發佈",
    hkTimeHint: "時間以香港時間（Asia/Hong_Kong）輸入。",
    startAt: "開始時間",
    endAt: "結束時間（可留空）",
    saveDraft: "儲存草稿",
    saving: "儲存中…",
    ...
    publishing: "發佈中…",
    previewTitle: "首頁預覽",
    previewHint: "可切換手機或桌面寬度；切換模板不會清除另一份草稿。",
    previewViewportLabel: "預覽寬度",
    previewMobile: "手機",
    previewDesktop: "桌面",
    previewEventHint: "此預覽只顯示已輸入的聚會 ID；正式首頁會載入聚會資料。",
    historyTitle: "發佈紀錄",
    historyLoading: "正在載入發佈紀錄…",
    historyUnavailable: "發佈紀錄暫時無法載入。",
    historyEmpty: "尚無發佈紀錄。",
    historyVersion: "版本",
    historyBy: "由",
    historyViewDiff: "查看前後版本",
    historyBefore: "發佈前",
    historyAfter: "發佈後",
    historyNoPrevious: "首次發佈，沒有更早的已發佈版本。",
    historyNoContent: "（沒有內容）",
  },
  management: {
    pageTitle: "管理中心",
    pageLead: "依照你的授權範圍，集中處理會員、事工營運與系統工作。",
    loading: "正在確認管理中心權限…",
    loadError: "無法載入管理中心權限",
    forbidden: "目前沒有可用的管理範圍。",
    forbiddenHint: "你的授權範圍可能已變更，請返回首頁或稍後再試。",
    retry: "重試載入管理中心",
    backToHub: "返回管理中心",
    groupMembership: "會員與權限",
    groupOperations: "事工營運",
    groupContent: "內容與系統",
    registrationApprovals: "註冊審批",
    registrationApprovalsHint: "檢視申請，核准或附註原因後拒絕。",
    memberDirectory: "會友名錄",
    memberDirectoryHint: "在你獲授權的範圍內搜尋會友。",
    accountPermissions: "帳戶權限",
    accountPermissionsHint: "唯讀檢視目前帳戶與伺服器授權。",
    programManagement: "課程與部門",
    programManagementHint: "管理部門設定與已授權課程。",
    eventOperations: "聚會與出席",
    eventOperationsHint: "開啟出席操作員工作區。",
    careOperations: "關懷儀表板",
    careOperationsHint: "開啟關懷工作區。",
    homeContent: "首頁內容",
    homeContentHint: "管理已授權的首頁內容。",
    moduleLoadError: "此工作區暫時無法載入。",
    memberSearchLabel: "搜尋會友",
    memberSearchHint: "輸入至少兩個字元，搜尋姓名、用戶名稱或電話。",
    memberSearchPlaceholder: "姓名、用戶名稱或電話",
    memberSearchSubmit: "搜尋",
    memberSearchLoading: "正在搜尋會友…",
    memberSearchEmpty: "找不到符合的會友。",
    memberSearchMinLength: "請輸入至少兩個字元。",
    memberSearchError: "無法搜尋會友，請稍後再試。",
    memberSearchForbidden: "你目前沒有權限搜尋會友。",
    memberSearchResults: "搜尋結果",
    memberDetailTitle: "會友資料",
    memberDetailClose: "關閉資料",
    memberDetailUsername: "用戶名稱",
    memberDetailRole: "角色",
    memberDetailPhone: "電話",
    memberDetailDepartments: "所屬部門",
    memberPhoneUnavailable: "未提供",
    memberDepartmentUnavailable: "目前沒有已報名的部門資料。",
    permissionProfile: "目前帳戶",
    permissionRole: "角色",
    permissionStatus: "帳戶狀態",
    permissionManagementScopes: "部門管理範圍",
    permissionProgramScopes: "課程管理範圍",
    permissionCapabilities: "伺服器授權項目",
    permissionCapability: "授權",
    permissionSection: "功能",
    careUnavailable: "關懷工作區目前沒有可操作資料；請稍後再試或返回管理中心。",
  },
  nav: {
    backToHome: "返回首頁",
  ...
  attention: {
    bellLabel: "開啟待處理與通知中心",
    title: "待處理與通知",
    tasksTab: "待處理",
    notificationsTab: "通知",
    taskListLabel: "待處理工作",
    notificationListLabel: "通知清單",
    loading: "正在載入待處理與通知…",
    retry: "重試載入",
    emptyTasks: "目前沒有需要處理的工作。",
    emptyNotifications: "目前沒有新的通知。",
    markAllRead: "全部標示已讀",
    markedRead: "通知已標示為已讀。",
    moduleMembership: "會員與權限",
    modulePrograms: "課程",
    moduleAttendance: "聚會／出席",
    moduleHome: "首頁內容",
    priorityHigh: "高",
    priorityNormal: "一般",
    priorityLow: "低",
    warning: "需要注意",
    taskPriorityLabel: "工作優先級",
  ...
  programs: {
    ...
    workspaceNextEvent: "下一聚會",
    workspaceNearestEvent: "最近聚會",
    workspaceNearestEventNone: "目前沒有可用的聚會資料。",
    workspaceOperations: "營運",
    workspaceOther: "其他",
    workspaceOtherKicker: "低頻設定",
    workspaceOtherFacts: "課程資料",
    workspaceOtherFactsLead: "只讀摘要與分類標籤",
    workspaceOtherSettings: "設定",
    workspaceOtherSettingsLead: "課程範圍內的簽到及報名規則",
    workspaceOtherNotifications: "通知",
    workspaceOtherNotificationsLead: "課程消息訂閱及提醒",
    workspaceUpcomingEvents: "即將舉行聚會",
    workspaceUpcomingEventCount: "{count} 場",
    workspaceSummaryCountUnavailable: "—",
    workspaceRosterCta: "前往管理名單",
    workspaceCheckInProgress: "已簽到 {checked}/{active}",
    workspacePendingApprovals: "待審批報名 ×{count}",
    ...
    workspaceTaskAssistedEnrollment: "新增報名",
    workspaceTaskRoster: "簽到名單",
    ...
    detailEventOpen: "查看聚會詳情",
    participantEventDetailTitle: "聚會詳情",
    participantEventDetailBack: "返回",
    eventDetailStatusOpen: "可簽到",
    eventDetailStatusUpcoming: "尚未開放簽到",
    eventDetailStatusClosed: "簽到已結束",
    eventDetailStatusUnavailable: "簽到時間未設定",
    eventDetailWhen: "時間",
    eventDetailLocation: "地點",
    eventDetailLocationUnavailable: "場地待公布",
    eventDetailInstructions: "簽到說明",
    eventDetailInstructionsText:
      "到達場地後，掃描聚會二維碼。系統確認聚會及你的報名狀態後，才會完成簽到。",
    eventDetailScan: "前往掃描",
    ...
    cancelEnrollmentConfirmation: "保留目前狀態",
