...
export const COPY = {
  ...
  attendance: {
    ...
    eventCheckInSheetTitle: "今次聚會簽到告示牌",
    eventCheckInSheetLead:
      "內容跟隨目前聚會資料；如日期、時間或地點有變，請重新產生告示牌。",
    eventCheckInSheetLoading: "正在準備今次聚會告示牌…",
    eventCheckInSheetUnavailable: "今次聚會暫時沒有可用的簽到代碼。",
    eventCheckInSheetQrLabel: "今次聚會簽到 QR 碼",
    eventCheckInSheetOpen: "開啟今次簽到告示牌",
    eventCheckInSheetDownload: "下載 QR 圖片",
    eventCheckInSheetPrint: "列印簽到告示牌",
    eventCheckInSheetClose: "關閉簽到告示牌",
  },
  profile: {
    title: "我的帳戶",
