...
export const COPY = {
  ...
  attendance: {
    ...
    manualEntryLead: "代碼通常顯示在場地入口或聚會螢幕。",
    manualClose: "關閉",
  ...
  notices: {
    noticesTitle: "通知",
    noticesLead: "聚會、報名及帳戶相關消息。",
    noticesLatest: "最新",
    noticesLoading: "正在載入通知…",
    noticesEmpty: "暫時沒有通知",
    noticesEmptyHint: "有新的聚會或帳戶消息時，會在這裡顯示。",
    noticesMarkAllRead: "全部標示已讀",
    noticesMarkedAllRead: "所有通知已標示為已讀",
