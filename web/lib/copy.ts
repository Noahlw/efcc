...
export const COPY = {
 ...
 attendance: {
  ...
  eventAttendanceLead:
   "查看此聚會的出席名單、處理代簽，或開啟 Event QR code。",
  eventId: "聚會 ID",
  ...
  assistedCheckInSuccess: (name: string, event: string) =>
   `${name} 已在「${event}」簽到。`,
  assistedCheckInDuplicate: (name: string, event: string) =>
   `${name} 已在「${event}」完成簽到。`,
  roster: "簽到名單",
  rosterTitle: "簽到名單",
  participantDetailTitle: "參與者詳情",
  participantDetailIdentity: "參與者",
  participantDetailHistory: "出席紀錄",
  participantDetailNoHistory: "目前沒有其他出席紀錄。",
  participantDetailCheckedInAt: "簽到時間",
  participantDetailDisposition: "請假紀錄",
  participantDetailRecordedAt: "記錄時間",
  participantDetailClose: "關閉詳情",
  participantDetailStatus: "目前狀態",
  participantDetailPhone: "已授權聯絡資料",
  participantDetailVoid: "簽到已作廢",
  excuseReasonPlaceholder: "選擇原因",
  excuseDetails: "補充說明",
  excuseDetailsOptional: "（可選）",
  excuseDetailsRequired: "（必須填寫）",
  ...
  rescan: "重新掃描",
  eventContextReady: "今次簽到聚會：{event}。請掃描現場 QR 或輸入聚會代碼。",
  eventContextTitle: "簽到聚會",
  eventCredentialMismatch:
   "呢個碼對應聚會 {event}，不是你開始簽到的聚會。請重新掃描。",
  outcomeHeader: "簽到狀態",
  ...
  eventCheckInSheetTitle: "Event QR code",
  eventCheckInSheetLead:
   "顯示此聚會最新資料、可掃描的 Program QR 及手動代碼；資料有變請重新開啟。",
  eventCheckInSheetLoading: "正在準備今次 Event QR code…",
  eventCheckInSheetUnavailable: "今次聚會暫時沒有可用的簽到代碼。",
  eventCheckInSheetQrLabel: "今次 Event QR code",
  eventCheckInSheetOpen: "開啟 Event QR code",
  eventCheckInSheetDownload: "下載 Event QR code 圖片",
  eventCheckInSheetPrint: "列印 Event QR code",
  eventCheckInSheetClose: "關閉 Event QR code",
  eventQrCodeFacts: "今次聚會資料",
 ...
 programs: {
  ...
  managementPageTitle: "管理課程",
  managementPageLead: "管理你獲授權嘅課程、聚會同參與者。",
  ...
  cockpitNoOpenCheckIn: "目前沒有開放簽到的聚會",
  cockpitNoOpenCheckInHint: "你可以查看聚會列表，或稍後再回來確認。",
  ...
  notificationsScreenLead: "課程管理 · 需要你處理嘅事項",
  ...
  workspaceOverviewTab: "概覽",
  workspaceTaskEvents: "聚會",
  workspaceTaskParticipants: "參與者",
  workspaceTaskSchedule: "排程",
  workspaceSettingsTab: "設定",
  workspaceTaskSettings: "課程設定",
  workspaceTaskNotifications: "管理通知",
  notificationsUnreadSection: "未讀通知",
  notificationsEarlierSection: "較早通知",
  ...
  schedulePageLead: "設定重複規則、預覽將來聚會，再按需要生成。",
  scheduleRulesTitle: "自動聚會規則",
  schedulePreviewTitle: "預覽將來聚會",
  scheduleGenerateTitle: "生成",
  settingsHubTitle: "課程設定",
  settingsHubLead: "將低頻設定分組，進入專注 editor 後先修改。",
  settingsHubBasics: "課程基本資料",
  settingsHubBasicsHint: "名稱、描述同分類",
  settingsHubPublishing: "發布與顯示",
  settingsHubPublishingHint: "狀態同可見範圍",
  settingsHubEnrollment: "報名設定",
  settingsHubEnrollmentHint: "報名模式同參與規則",
  settingsHubAccess: "負責人 / 帳戶存取",
  settingsHubAccessHint: "使用 normalized Account Access authority",
  settingsHubSchedule: "聚會排程",
  settingsHubScheduleHint: "重複規則、預覽同生成",
  settingsHubAttendance: "出席與簽到",
  settingsHubAttendanceHint: "簽到開放及關閉時間",
  settingsHubNotifications: "通知設定",
  settingsHubNotificationsHint: "課程管理通知",
  settingsHubArchive: "封存課程",
  ...
  settingsPublishingLead:
   "更新課程狀態及可見範圍；封存前會保留現有承諾檢查。",
  ...
  settingsLeaveDescription:
   "如果離開，未儲存的設定變更會被捨棄。你可以繼續編輯，或確認捨棄並離開。",
  settingsContinueEditing: "繼續編輯",
  settingsDiscardAndLeave: "捨棄並離開",
  settingsRetrySave: "重試儲存",
  ...
  settingsRuleStartDate: "規則開始日期",
  settingsRuleEndDate: "規則結束日期（可留空）",
  settingsRuleOngoing: "無結束日期；此規則會持續有效。",
  ...
  settingsExceptionBeyondRuleEnd:
   "改期日期超出規則結束日；只會改動今次，不會延長規則。",
  ...
  settingsAttendanceQrTitle: "永久課程 QR",
  settingsAttendanceQrLead:
  ...
  settingsAttendanceQrRotateBody:
   "現有 QR 會即時失效，所有已下載或已張貼的舊告示牌都必須更換；新 QR 會繼續解析到最新可簽到聚會。",
  settingsAttendanceQrRotateConfirm: "確認更換",
  settingsAttendanceQrRotateCancel: "保留目前 QR",
  settingsAttendanceQrRotated: "永久課程 QR 已更換；請下載並替換現場告示牌。",
  settingsAttendanceQrRotationDenied: "目前帳戶不能更換永久課程 QR。",
  ...
  scheduleCancelledEventsGroup: "已取消聚會",
  ...
  departmentSettingsLoadError: "無法載入部門設定",
  ...
  previewOccurrenceOriginal: "原定 {date}",
  previewOccurrenceReplacement: "改至 {date}",
  previewSkipOccurrence: "略過本次",
  previewRescheduleOccurrence: "改期本次",
  previewSaveException: "儲存今次安排",
  previewCancelDraft: "取消草稿",
  previewExceptionDraft: "未儲存草稿",
  previewOrphanDraftsTitle: "未完成的預覽調整草稿",
  previewOrphanDraftsLead:
   "這些調整不在目前預覽範圍；你可以恢復繼續編輯，或捨棄草稿。",
  previewAdjustOccurrence: "調整",
  previewAdjustSheetTitle: "調整今次安排",
  previewAdjustSheetLead: "選擇略過或改期；儲存前不會更改時間表。",
  previewRemoveException: "移除已儲存安排",
  previewMonthlyOmission:
  ...
  generatedReconcileUnknown: "核對產生結果後再試",
  generatedCompletedDetails: "查看處理詳情",
  generatedCreatedEvent: "查看聚會",
  generateRequiresRecurring: "只有定期課程可產生聚會。",
  createEvent: "新增聚會",
  createMeeting: "建立聚會",
  createMeetingValidation: "請輸入日期、開始及結束時間，以及聚會名稱。",
  editMeeting: "編輯聚會",
  eventType: "類型",
  recurrenceTag: "重複標記",
  ...
  eventEditLeaveTitle: "未儲存聚會資料變更",
  eventEditLeaveDescription:
   "如果離開，未儲存的聚會資料變更會被捨棄。你可以繼續編輯，或確認捨棄並離開。",
  eventDetailOpen: "詳情",
  eventMoreActions: "更多操作",
  eventsFilterLabel: "聚會篩選",
  eventsFilterCurrent: "目前及即將",
  eventsFilterPast: "過往",
  eventsFilterCancelled: "已取消",
  ...
  participantAttendanceExcused: "已請假",
  participantAttendanceCancelled: "聚會已取消",
  ...
  eventName: "聚會名稱",
  eventNameRequired: "請輸入聚會名稱。",
  eventNamePlaceholder: "輸入聚會名稱",
  eventLocation: "地點",
  ...
  eventAvailabilityConfirmRequired:
   "此聚會有進行中的操作，需確認後才能暫停。",
  eventRescheduleBlocked:
   "聚會開始或建立點名快照後，不能更改時間；請取消原聚會再建立新聚會。",
  ...
  eventCheckInWindowOverride: "自行設定今次聚會的簽到時間",
  eventCheckInWindowCalculated: "簽到時間會按課程預設計算。",
...
const ERROR_COPY_BY_CODE: Record<string, string> = {
 ...
 SCHEDULE_RULE_IDEMPOTENCY_CONFLICT: COPY.error.conflict,
