...
export const UI_CONTRACT_REGISTRY: readonly UIContract[] = [
  {
    ...
    layer: "global",
    scope: "apps/web/app/globals.css",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "global",
    scope: "apps/web/lib/nav-bar.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "primitive",
    scope: "apps/web/components/ui/dialog.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "pattern",
    scope: "apps/web/app/management/management-action-framework.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "pattern",
    scope: "apps/web/app/management/directory-frame.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "pattern",
    scope: "apps/web/lib/feed-presentation.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "pattern",
    scope: "apps/web/app/management/role-hierarchy-panel.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "pattern",
    scope: "apps/web/app/management/permission-editor-panel.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "pattern",
    scope: "apps/web/app/management/home-cms-editor.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "route",
    scope: "apps/web/lib/attendance-scanner-ui.tsx",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "primitive",
    scope: "apps/web/COMPONENT_INVENTORY.md",
    probes: [
      {
  ...
  },
  {
    ...
    layer: "global",
    scope: "apps/web/app/**;apps/web/lib/**",
    probes: [
      {
...
export const APPROVAL_PACKAGE_REGISTRY: readonly ApprovalPackage[] = [
  ...
  },
  {
    ...
    scope: [
      ...
      "apps/web/lib/directory-frame.tsx",
    ],
    baselineSha: "3cc674f4e2240abaebb47bb75c6614a8c3d7c624",
  ...
  {
    id: "APV-T07-WORKSHOP-FIDELITY-5D22835D",
    title: "T07 Storybook workshop-fidelity approval at reviewed revision",
    rationale:
      "The repository owner compared representative Storybook presentations with the local EFCC application at the reviewed implementation revision and approved Storybook as the current local presentation workshop.",
    scope: [
      "T07 / #512",
      "T07.1–T07.5 / #566–#570 representative presentation families",
      "local Storybook workshop and Screen Catalog",
    ],
    baselineSha: "5d22835de0d3b1802e2ae84b774066edc5e24a2f",
    approvedBy: "Noah Wong / Repository Owner",
    approvedAt: "2026-09-07T04:43:34Z",
    affectedRoutes: [
      "/management",
      "/",
      "/home",
    ...
    evidenceRef: "docs/qa/2026-09-07-t07-workshop-fidelity-approval.md",
    ...
    presentationPsns: [
      ...
      "PSN-MGMT-ACCOUNT-DIRECTORY",
      "PSN-MGMT-APPROVAL-QUEUE",
      "PSN-MGMT-REGISTRATIONS-FALLBACK",
      "PSN-ATTENDANCE-GUEST-CHECK-IN",
      "PSN-ATTENDANCE-SCANNER-BOUNDARY",
      "PSN-ATTENDANCE-ASSISTED-CHECK-IN",
    ],
    status: "approved",
  },
  {
    ...
    scope: [
      "T08 / #513",
      "apps/web/components/ui/*",
      "apps/web/.storybook/controls.stories.tsx",
    ],
...
export const WAIVER_REGISTRY: readonly Waiver[] = [
  {
    ...
    viewports: [320, 390, 600, 799, 800, 1024, 1440],
    browsers: ["chromium", "firefox", "webkit"],
    affectedFiles: ["apps/web/app/not-found.tsx"],
  ...
  },
  {
    ...
    browsers: ["chromium", "firefox", "webkit"],
    affectedFiles: [
      "apps/web/app/management/account-access-panel.tsx",
      "apps/web/app/management/permission-editor-panel.tsx",
      "apps/web/app/management/role-hierarchy-panel.tsx",
...
export const NATIVE_EXCEPTION_REGISTRY: readonly NativeException[] = [
  {
    ...
    location: "apps/web/lib/attendance-scanner-ui.tsx",
  ...
  },
  {
    ...
    location: "apps/web/lib/assisted-scanner-panel.tsx",
  ...
  },
  {
    ...
    location: "apps/web/app/management/home-cms-editor.tsx",
  ...
  },
  {
    ...
    location: "apps/web/lib/programs/event-detail.tsx",
    reason:
  ...
  },
  {
    ...
    location: "apps/web/lib/programs/member-picker.tsx",
  ...
  },
  {
    ...
    location: "apps/web/lib/programs/programs-notifications.tsx",
