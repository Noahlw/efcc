...
function ownershipLayerHint(layer: OwnershipLayer): string {
  switch (layer) {
    case "global":
      return "apps/web/app/globals.css or shell chrome tokens";
    case "primitive":
      return "apps/web/components/ui/ local primitives";
    case "pattern":
      return "apps/web/lib/ or shared management composition modules";
    case "route":
      return "apps/web/app/ domain page or route-specific arrangement";
  }
}
