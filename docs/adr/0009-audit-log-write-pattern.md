...
- **Status**: Accepted (Grill Session 5.1, locked 2026-07-28)
- **Deciders**: Noah Wong, OMP planner (grill-with-docs)
- **Date**: 2026-07-28
- **Related**: ADR-0006 (Audit_Log sheet origin), ADR-0008 (restart from template — this ADR covers a sub-decision of the rebuild)
