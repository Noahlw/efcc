...
The earlier candidate-bound acceptance record is in [evidence.json](../../.delivery/repo-wide-organization-implementation/evidence.json); it records code candidate `0a5112c3f91f67a724e001fa6c37469089ac3ee0` and its remaining gates. The latest full local aggregate is the `fc0cf979` promotion manifest linked above. Do not present the older evidence record as the latest run. Both records make no token-savings claim.
