...
- **Review-fix checkpoint:** `380a0ffe1d6b8fea1cffc8e3e7e0fd2e23ebc677` — fail-closed canary classification/timing/artifact checks, same-key idempotency replay, expanded responsive intent, and removal of unused Browser Harness fixture setup; focused reruns passed.
