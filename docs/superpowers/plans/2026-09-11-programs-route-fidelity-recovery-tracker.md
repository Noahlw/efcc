...
| R8 | [Fixed-point qualification](programs-route-fidelity-recovery/R8-fixed-point-qualification.md) | BLOCKED | `ca63fc143602f5e99cfe620d464e18477c9a3671` | `test(programs): requalify route fidelity recovery` | every machine-candidate gate + zero-actionable review | Fresh Steps 1–5 are machine-evidenced at `ca63fc143602`: visual `2/2`, 22/22 visual rows PASS, clean promotion `functional-passed`, required route/component/Storybook/precommit gates PASS, and T09/role-hierarchy failures are base-proven ambient limitations. R8B closed the narrow Schedule/Notifications observation contract, but the fixed-point review found residual R6/T11 and truthful-identity evidence gaps routed to R8C. Authority findings remain disclosed separately; do not claim `WAITING_OWNER_L2` until R8 restarts and the final review is recorded. |
