...
| R5 | [Schedule recovery Plays](programs-route-fidelity-recovery/R5-schedule-recovery-plays.md) | IN_PROGRESS | `b0b6356b2ba59b599b9844ee016653f7d2c08ad0` | `test(programs): exercise schedule recovery seams` | focused Schedule components + Storybook/T11 | Steps 2–8 green: stateful fixture isolation, named Events/Schedule Plays, stale re-preview, partial resume, focused components, foundation, Storybook `94/94`, T11 `117/117` across 9 W7 viewports, root/web typecheck, diff check; next action is commit and close R5 |
