...
FINAL standing state (session end): the efcc-dev-testing worker serves rebase/prg-05-201 head (programs + auth design/quality, Version 5301dfad-557e-449e-bc2b-2a5ac8975b28) — it does NOT include the attendance feature. Running attendance-d1 requires deploying the att-qr-213-215 head first (procedure in docs/omp-plans/2026-08-07-att-04-ticket-216.md §3).
