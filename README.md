...
| Programs | Finite layered qualification passed; B-003 sustained-runtime residual risk remains open | Worker + D1 `/api/v1/programs/*` | Worker + D1 | Publish/review/merge the replacement T05 PR, then restack and revalidate T06; legacy Programs suite remains diagnostic-only |
