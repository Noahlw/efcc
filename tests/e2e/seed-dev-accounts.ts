  ...
  if (reset) {
    ...
    process.stdout.write(
      [
        ...
        `DELETE FROM enrollment_approval_run_items WHERE run_id IN (SELECT run_id FROM enrollment_approval_runs WHERE program_id IN ${e2eProgramIds});`,
        `DELETE FROM enrollment_approval_runs WHERE program_id IN ${e2eProgramIds};`,
