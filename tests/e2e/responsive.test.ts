...
import { defaultSections } from "../../web/lib/sections";
  ...
  if (path === "/api/v1/auth/me" && method === "GET") {
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        data: {
          user: PUBLIC_USER,
          // R1 contract: /auth/me returns the server's section projection;
          // this browser fixture does not derive visibility from role.
