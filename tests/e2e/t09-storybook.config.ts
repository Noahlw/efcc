...
export default defineConfig({
  testDir: dirname,
  testMatch: /t09-foundation-overlays\.test\.ts/u,
  timeout: 30_000,
  ...
  reporter: [
    ["list"],
    ["json", { outputFile: "test-results/t09-foundations/storybook.json" }],
  ],
  use: {
    baseURL,
  ...
  webServer: {
    ...
    cwd: repositoryRoot,
    url: `${baseURL}/iframe.html?id=foundations--surface&viewMode=story`,
