  ...
  overrides: [
    {
      ...
      files: [
        ...
        "apps/web/lib/attendance-operator-panel.tsx",
        "apps/web/lib/auth/registrations.ts",
        "apps/web/app/management/permissions-panel.tsx",
    ...
    },
    {
      files: [
        ...
        "apps/web/lib/attendance-panel.tsx",
        "apps/web/lib/attendance-operator-panel.tsx",
        "apps/web/lib/assisted-scanner-panel.tsx",
        "apps/web/lib/self-check-in-panel.tsx",
        "apps/web/lib/scanner-boundary.tsx",
        "apps/web/lib/attendance-scanner-ui.tsx",
      ],
      rules: {
